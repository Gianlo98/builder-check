              ...
              return (
                ...
                >
                  {formatter && item?.value !== undefined && item.name ? (
                    (formatter as (value: unknown, name: string, item: Record<string, unknown>, index: number, payload: unknown) => React.ReactNode)(item.value, item.name as string, item as unknown as Record<string, unknown>, index, item.payload)
                  ) : (
                    <>
                      {itemConfig?.icon ? (
                        <itemConfig.icon />
